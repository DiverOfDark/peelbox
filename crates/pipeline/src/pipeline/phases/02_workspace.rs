...
use peelbox_stack::orchestrator::{Package, WorkspaceStructure};
...
fn extract_package_metadata(
    detection: &peelbox_stack::DetectionStack,
...
mod tests {
    ...
    fn test_single_service_workspace() {
        ...
        use peelbox_stack::DetectionStack;
