...
fn try_deterministic(
    ...
    let wolfi_index = peelbox_wolfi::WolfiPackageIndex::fetch().ok()?;
...
impl ServicePhase for BuildPhase {
    ...
    async fn execute(&self, context: &mut ServiceContext) -> Result<()> {
        ...
        use peelbox_stack::BuildSystemId;
...
mod tests {
    ...
    fn test_deterministic_cargo() {
        ...
        let build_system = stack_registry
            .get_build_system(peelbox_stack::BuildSystemId::Cargo)
            .unwrap();
    ...
    fn test_deterministic_maven() {
        ...
        let build_system = stack_registry
            .get_build_system(peelbox_stack::BuildSystemId::Maven)
            .unwrap();
