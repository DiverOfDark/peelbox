...
use peelbox_stack::{FrameworkId, LanguageId, RuntimeId, StackRegistry};
...
fn try_detect_stack(
    language: LanguageId,
    build_system: peelbox_stack::BuildSystemId,
...
mod tests {
    ...
    fn test_detect_stack_rust() {
        ...
        assert_eq!(stack.build_system, peelbox_stack::BuildSystemId::Cargo);
    ...
    fn test_detect_stack_node() {
        ...
        assert_eq!(stack.build_system, peelbox_stack::BuildSystemId::Npm);
