...
mod tests {
    ...
    use crate::pipeline::Confidence;
    use peelbox_stack::orchestrator::{OrchestratorId, WorkspaceStructure};
    use peelbox_stack::{BuildSystemId, DetectionStack, LanguageId};
    ...
    async fn test_root_cache_turborepo() {
        ...
        let workspace = WorkspaceStructure {
            orchestrator: Some(OrchestratorId::Turborepo),
            packages: vec![
                peelbox_stack::orchestrator::Package {
