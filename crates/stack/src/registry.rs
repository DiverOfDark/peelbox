...
impl StackRegistry {
    ...
    pub fn detect_all_stacks(
        ...
        fs: &dyn peelbox_core::fs::FileSystem,
        detection_mode: peelbox_core::config::DetectionMode,
    ...
    pub fn get_runtime(
        ...
        id: RuntimeId,
        llm_client: Option<Arc<dyn LLMClient>>,
    ) -> Box<dyn crate::runtime::Runtime> {
        match id {
            RuntimeId::JVM => Box::new(crate::runtime::JvmRuntime),
            RuntimeId::Node => Box::new(crate::runtime::NodeRuntime),
            RuntimeId::Python => Box::new(crate::runtime::PythonRuntime),
            RuntimeId::Ruby => Box::new(crate::runtime::RubyRuntime),
            RuntimeId::PHP => Box::new(crate::runtime::PhpRuntime),
