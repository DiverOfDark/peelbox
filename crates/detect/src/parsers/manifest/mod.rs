...
pub use deps_edn::DepsEdnParser;
pub use environment_yml::EnvironmentYmlParser;
pub use gemfile::GemfileParser;
pub use gleam_toml::GleamTomlParser;
pub use go_main::GoMainParser;
...
pub use python_script::PythonScriptParser;
pub use requirements_txt::RequirementsTxtParser;
pub use scheme::SchemeHauntParser;
pub use settings_gradle::SettingsGradleParser;
pub use setup_py::SetupPyParser;
pub use shard_yml::ShardYmlParser;
pub use shell_script::ShellScriptParser;
pub use stack_yaml::StackYamlParser;
pub use staticfile::StaticfileParser;
